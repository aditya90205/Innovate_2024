...
const PieCharts = () => {
  ...
  const order = data?.charts.orderFillfillment!;
        ...
        {isLoading ? (
          ...
          <>
            ...
            <section>
              <div>
                <DoughnutChart
                  labels={categories.map((i) => Object.keys(i)[0])} // Object.keys(i)[0] is the category name
                  data={categories.map((i) => Object.values(i)[0])} // Object.values(i)[0] is the category value
